...
See `docs/hardware/bios-update-dell-9020m.md` for detailed instructions.
...
2. **Change Package Mirror to UK** (Recommended):
   ...
   **See `docs/ubuntu/ubuntu-mirror-config.md`** for detailed instructions and alternative UK mirrors.
...
1. Follow `docs/setup/node1-first-setup.md` for Node 1
